...
export function OfflineBanner() {
  const { isOffline, allAvailable } = useOfflineCourse();
  ...
  return (
    ...
    >
      ...
      {allAvailable
        ? "Offline — every lesson is available; progress is saved on this device."
        : "Offline — lessons marked in the sidebar aren't downloaded yet."}
    </div>
  );
}
